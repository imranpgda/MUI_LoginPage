  ...
  return (
    <>
      ...
      <div className="w-[90%] h-[30px]">
        <ul class="flex justify-center mt-[20%] space-x-5">
          {/* <li>
            <a
              href="https://www.linkedin.com/in/imranpgda/"
              class="text-gray-500 hover:text-black dark:hover:text-black transition-all dark:text-gray-400"
            >
              <svg
          ...
          <li>
            <a
              href="https://www.instagram.com/imranpgda"
              class="text-gray-500 hover:text-black dark:hover:text-black transition-all dark:text-gray-400"
            >
              <svg
                class="w-6 h-6"
          ...
          <li>
            <a
              href="https://twitter.com/imranpgda"
              class="text-gray-500 hover:text-black dark:hover:text-black transition-all dark:text-gray-400"
            >
              <svg
                class="w-6 h-6"
          ...
          <li>
            <a
              href="https://github.com/imranpgda"
              class="text-gray-500 hover:text-black dark:hover:text-black transition-all dark:text-gray-400"
            >
              <svg
                class="w-6 h-6"
        ...
        <div className="bg-white mt-[10px] rounded-md text-[12px] font-sans text-center">
          Contact Developer
        </div>
      </div>
    </>
